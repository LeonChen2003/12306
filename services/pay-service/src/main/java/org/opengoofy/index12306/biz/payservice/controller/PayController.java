...
public class PayController {
  ...
  /** 公共支付接口 对接常用支付方式，比如：支付宝、微信以及银行卡等 */
  ...
  public Result<PayInfoRespDTO> getPayInfoByOrderSn(
  ...
  /** 公共退款接口 后续为了方便开发系列退款相关接口，已迁移 {@link RefundController#commonRefund(RefundReqDTO)} */
  @Deprecated
