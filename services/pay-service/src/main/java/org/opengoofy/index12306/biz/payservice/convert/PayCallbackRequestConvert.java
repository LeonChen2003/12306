...
public final class PayCallbackRequestConvert {
   ...
   */
  public static PayCallbackRequest command2PayCallbackRequest(
    ...
    if (Objects.equals(payCallbackCommand.getChannel(), PayChannelEnum.ALI_PAY.getCode())) {
      ...
      ((AliPayCallbackRequest) payCallbackRequest)
          .setOrderRequestId(payCallbackCommand.getOrderRequestId());
    }
