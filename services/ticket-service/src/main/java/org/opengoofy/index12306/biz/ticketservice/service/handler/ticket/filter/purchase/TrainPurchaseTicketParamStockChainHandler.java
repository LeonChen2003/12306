...
public class TrainPurchaseTicketParamStockChainHandler
  ...
  public void handler(PurchaseTicketReqDTO requestParam) {
    ...
    String keySuffix =
        StrUtil.join(
            "_", requestParam.getTrainId(), requestParam.getDeparture(), requestParam.getArrival());
    ...
    seatTypeMap.forEach(
        (seatType, passengerSeatDetails) -> {
          Object stockObj =
              stringRedisTemplate
                  .opsForHash()
                  .get(TRAIN_STATION_REMAINING_TICKET + keySuffix, String.valueOf(seatType));
          int stock =
              Optional.ofNullable(stockObj)
