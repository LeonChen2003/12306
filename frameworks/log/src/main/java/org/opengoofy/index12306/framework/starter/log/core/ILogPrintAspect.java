...
public class ILogPrintAspect {
  ...
  /** 打印类或方法上的 {@link ILog} */
  @Around(
      "@within(org.opengoofy.index12306.framework.starter.log.annotation.ILog) || @annotation(org.opengoofy.index12306.framework.starter.log.annotation.ILog)")
  public Object printMLog(ProceedingJoinPoint joinPoint) throws Throwable {
    ...
    try {
      ...
      ILog logAnnotation =
          Optional.ofNullable(targetMethod.getAnnotation(ILog.class))
